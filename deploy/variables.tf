...
variable "backup_image" {
  description = "Docker image used for the per-server backup service (mc-backup). Pinned to the metio fork; the upstream itzg/mc-backup is the fallback for local development only."
  type        = string
