...
// --- cancelScheduledShutdownByID tests ---
...
func TestCancelScheduledShutdownByID_Success(t *testing.T) {
	...
	req = mux.SetURLVars(req, map[string]string{"id": "srv1"})
	w := httptest.NewRecorder()
	cancelScheduledShutdownByID(w, req)
